...
class Update implements Event
{
    ...
    public function getChatType(): null|string
    {
        return $this->message?->chat?->type
            ?? $this->edited_message?->chat?->type
            ?? $this->channel_post?->chat?->type
            ?? $this->edited_channel_post?->chat?->type
            ?? $this->callback_query?->message?->chat?->type
            ?? $this->inline_query?->chat_type
            ?? $this->message_reaction?->chat?->type;
    }
}
